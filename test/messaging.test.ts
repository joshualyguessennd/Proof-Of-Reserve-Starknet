...
describe("test contracts interaction", function () {
    ...
    it("check deployment data", async () => {
        const { l1Contract, l2Contract, l2user, mockStarknetMessagingAddress, admin, l1_user } = await setupTest();
        const _selector = await l1Contract.SELECTOR();
        expect(_selector).to.be.eq(BigInt(1447471469451581726846414018284835017311951023166934288557129659906920235665))
        ...
        const tx = await l1Contract.connect(admin).addNewPublisher(admin.address);
